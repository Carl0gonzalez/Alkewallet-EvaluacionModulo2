...
public class UI {
    ...
    private static final int ALTURA_PANTALLA = 18;
    ...
    public static void dibujarFooter(double clp, double usd, double eur, double tasaUsd, double tasaEur) {
        ...
        System.out.printf("│ CLP: %-54s│%n", clpStr);
        System.out.printf("│ USD: %-54s│%n", usdStr);
        System.out.printf("│ EUR: %-54s│%n", eurStr);
    ...
    public static void pantallaLogueado(
        ...
        System.out.println("┌────────────────────────────────────────────────────────────┐");
        System.out.println("│ " + String.format("%-59s", tituloArriba) + "│");
        System.out.println("└────────────────────────────────────────────────────────────┘");
